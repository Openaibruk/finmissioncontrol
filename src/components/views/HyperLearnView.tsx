...
import {
  ...
  GenerationStatus,
  DiscoveryNode,
} from "@/lib/hyperlearn/types";
import Header from "@/components/hyperlearn/Header";
import InputBar from "@/components/hyperlearn/InputBar";
import LiveBrowserView from "@/components/hyperlearn/LiveBrowserView";
import SkillTreePanel from "@/components/hyperlearn/SkillTreePanel";
...
export default function HyperLearnView() {
  ...
  const startGeneration = useCallback(async (input: string) => {
    ...
    try {
      ...
      const response = await fetch("/api/hyperlearn/browse", {
        method: "POST",
